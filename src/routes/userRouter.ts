...
router.get("/:id", async (req: Request, res: Response) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Terjadi kesalahan saat mengambil pengguna.", error });
  }
});
...
router.put("/:id", async (req: Request, res: Response) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Terjadi kesalahan saat memperbarui pengguna.", error });
  }
});
...
router.delete("/:id", async (req: Request, res: Response) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Terjadi kesalahan saat menghapus pengguna.", error });
  }
});
